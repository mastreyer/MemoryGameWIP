...
public class MemoryActivity4x5  extends MainActivity implements View.OnClickListener{
    ...
    Integer[] flipped = new Integer[20];
    int[] Colors = new int[10];
    int[] buttonColor = new int[20];
    String PLAYERNAME;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_memory_4x5);
...
//If no match, delays for a short time then runs the runnable to fip the buttons back
                ...
                timingHandler.postDelayed(delay, 300);
            }
...
to start new game, and shows a toast message*/
            if(matchCounter == 10) {
                SharedPreferences prefsTime = getSharedPreferences("TIME4x5", MODE_PRIVATE);
